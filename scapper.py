...
def scrape():
    for page in range(1, 5):
        ...
        for car in cars:
            ...
            f_type = key_specs[4].get_text() if key_specs[4] else print('')
...
def main():
    ...
    parser.add_argument('export_to_csv', help='provide operator', type=export_to_csv(car_data))
    print("csv complete")
    parser.add_argument('export_to_xls', help='provide operator', type=export_to_xls(car_data))
    print("xls complete")
